...
km.set("n", "<leader>f", require("fzf-lua").live_grep, { desc = "Fuzzy Search (rg)" })
km.set("n", "<leader>b", require("fzf-lua").buffers, { desc = "FZF Buffers" })
km.set("v", "<leader>y", require("fzf-lua").grep_visual, { desc = "FZF Selection" })
km.set("n", "<leader>w", require("fzf-lua").grep_cword, { desc = "FZF Word" })
...
km.set("n", "<leader>gh", ":DiffviewFileHistory %<cr>", { desc = "Git file history" })
